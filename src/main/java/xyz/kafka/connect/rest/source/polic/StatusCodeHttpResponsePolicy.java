...
public class StatusCodeHttpResponsePolicy implements HttpResponsePolicy {
    ...
    public void configure(Map<String, ?> settings) {
        StatusCodeHttpResponsePolicyConfig config = new StatusCodeHttpResponsePolicyConfig(settings);
     ...
     * @since 2023-03-08
     */
    public static class StatusCodeHttpResponsePolicyConfig extends AbstractConfig {

        private static final String PROCESS_CODES = "rest.response.policy.codes.process";
        private static final String SKIP_CODES = "rest.response.policy.codes.skip";
